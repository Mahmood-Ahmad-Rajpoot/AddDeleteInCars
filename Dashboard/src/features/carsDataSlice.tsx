  ...
  reducers: {
    deleteCar: (state, action) => {
      const filteredData = state.carData.filter(
        (car) => car.car_id !== action.payload.car_id
      );
    ...
    editCar: (state, action) => {
      ...
      state.carData.map((car) => {
        if (car.car_id === car_id) {
          car.car_image = uploaded_image;
          car.car_type = car_type;
          car.hourly_rate = hourly_rate;
          car.luggage_capacity = luggage_capacity;
          car.minimum_fare = minimum_fare;
          car.minimum_hours = minimum_hours;
          car.passanger_capacity = passanger_capacity;
          car.price = price;
        }
      });
    },
    addNewCar: (state, action) => {
      console.log(action.payload, ":AddNew");
      ...
      const mergedObject = { ...action.payload, ...otherInfo };
      console.log(mergedObject, "merged1");
...
export const { deleteCar, editCar, addNewCar } = carDataSlice.actions;
